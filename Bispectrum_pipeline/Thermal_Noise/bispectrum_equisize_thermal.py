...
def belltest(lmax,nrLoops,start,end):
    ...
    for i in range(start, end):
        mapa = fits.getdata("ThermalNoise"+str(i)+".fits")
        print("mapa")    
    ###################################################################################
...
### Equiseze conditions
    ...
    np.savetxt('B_ell_Thermal_Noise_equisize'+str(i)+".txt", B_ell, delimiter=',')
    #np.savetxt('B_ellRecalculado'+str(i)+".txt", B_ell, delimiter=',')
    np.savetxt('B_ell_ell_Thermal_Noise_equisize'+str(i)+".txt", np.array([B_ell,l1_ell,l2_ell, l3_ell]).T, delimiter=',')
