...
### Isosceles conditions lmax is defined in belltest(lmax, nrlooos, star, end)
    ...
    np.savetxt('B_ell_Foregrounds_isoscels'+str(i)+".txt", B_ell, delimiter=',')
    #np.savetxt('B_ellRecalculado'+str(i)+".txt", B_ell, delimiter=',')
    np.savetxt('B_ell_ell_Foregrounds_isosceles'+str(i)+".txt", np.array([B_ell,l1_ell,l2_ell, l3_ell]).T, delimiter=',')
