...
def calculateMatrixBellStd(arq,arqMedia):
    matrixBell=np.loadtxt(arq) 
    matrixBellMean=np.std(matrixBell,axis=1)
    np.savetxt(arqMedia,matrixBellMean)

def calculateMatrixBellVar(arq,arqMedia):
    matrixBell=np.loadtxt(arq) 
    matrixBellMean=np.var(matrixBell,axis=1)
    np.savetxt(arqMedia,matrixBellMean)
